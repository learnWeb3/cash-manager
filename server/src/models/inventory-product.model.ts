...
export interface InventoryProductModel
  extends Model<IInventoryProduct, {}, InventoryProductMethods> {}

export type InventoryProductDocument = HydratedDocument<
  IInventoryProduct,
  {},
...
export const InventoryProduct = model<IInventoryProduct, InventoryProductModel>(
  "InventoryProduct",
